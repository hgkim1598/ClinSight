...
export const mockMetrics: WireMetric[] = [
  ...
  { config_key: 'pao2fio2ratio',     display_name: 'PaO2/FiO2',         metric_group: 'lab',     unit: '',         normal_range_low: 400,  normal_range_high: 500, sort_order: 12 },
  ...
  { config_key: 'bilirubin_total',   display_name: 'Bilirubin',         metric_group: 'lab',     unit: 'mg/dL',    normal_range_low: 0.2,  normal_range_high: 1.2, sort_order: 14 },
...
export const mockModels: WireModelMeta[] = [
  {
    ...
    input_features: ['hr', 'map', 'lactate', 'creatinine', 'platelet', 'bilirubin_total', 'pao2fio2ratio', 'gcs', 'urine_output', 'sofa_total'],
  },
  {
